...
import com.github.jaychenfe.wxshop.service.impl.OrderService;
...
public class OrderController {
    ...
    public Response<OrderResponse> updateOrder(@PathVariable("id") long id, @RequestBody Orders order) {
        order.setId(id);
